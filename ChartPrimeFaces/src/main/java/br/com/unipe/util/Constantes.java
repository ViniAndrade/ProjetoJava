...
//	ESTABELECIMENTO
	public static final String REST_GET_ESTABELECIMENTOS = URL_BASE + "livro/listar";
	public static final String REST_GET_ESTABELECIMENTO_ID = URL_BASE + "livro/livro/%s";
